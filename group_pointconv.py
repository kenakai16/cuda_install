...
class GroupPointConvDensityClsSsg(nn.Module):
    def __init__(self, num_classes = 40, split_group=24):
        ...
        # add residual blocks
        self.sa2 = RotationPointConvDensitySetAbstraction(npoint=128, nsample=64, in_channel=128 + npoint_dim, mlp=[128, 128, 256], bandwidth = 0.2, group_all=False, split_group=split_group)
        # add residual blocks
